...
form.elements[0].addEventListener('focus', saveToLocal);
// form.elements[1].addEventListener('focus', saveToLocal);
// form.elements[2].addEventListener('focus', saveToLocal);
